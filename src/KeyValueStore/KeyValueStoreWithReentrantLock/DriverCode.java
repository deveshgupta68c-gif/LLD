...
import KeyValueStore.InMemoryKeyValueStore;
...
public class DriverCode {
	public static void main(String[] args) {
		...
		try {
			KeyValueStore.<String, String> store = new KeyValueStore.InMemoryKeyValueStore<>(String.class);
		...
		try {
			KeyValueStore.KeyValueStore<String, String> store = new KeyValueStore.InMemoryKeyValueStore<>(String.class);
		...
		try {
			KeyValueStore.KeyValueStore<Integer, String> store = new KeyValueStore.InMemoryKeyValueStore<>(Integer.class);
		...
		try {
			...
			new KeyValueStore.InMemoryKeyValueStore<>(NonHashable.class);
		} catch (Exception e) {
